...
public class AllignmentTest extends JFrame implements Runnable, KeyListener {
    ...
    public AllignmentTest() {
        //Creates the window.
        super("WD: Allignment Tester");
        setSize(640,640);
        setVisible(true);
    ...
    public void update() {
        ...
        //Draws a single room, focusing on centering the coordinates.
        drawTest();
    ...
    //Draws the currently testing object, focusing on fixing coordinate bugs.
